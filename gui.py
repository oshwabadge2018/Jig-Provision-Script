...
application = thorpy.Application((320, 480), "Badge Programmer")
...
UpdateFirmware = thorpy.Clickable.make("Load Latest Firmware",size = (280,50))
UpdateProvisioner = thorpy.Clickable.make("Update Provisioner",size = (280,50))
